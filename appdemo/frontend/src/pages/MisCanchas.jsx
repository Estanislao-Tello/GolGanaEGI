...
const MisCanchas = () => {
    ...
    try {
        ...
        const res = await axios.get("https://golgana.com/api/canchas", {
    ...
    const obtenerDisciplinas = async () => {
        try {
            const res = await axios.get("https://golgana.com/api/disciplinas");
    ...
    const obtenerPredios = async () => {
        try {
            const res = await axios.get("https://golgana.com/api/predios"); // API para obtener predios
            setPredios(res.data);
        } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editando) {
                await axios.put(`https://golgana.com/api/canchas/${editando}`, formData, {
                    headers: { Authorization: `Bearer ${token}` },
                });
            } else {
                await axios.post("https://golgana.com/api/canchas", formData, {
                    headers: { Authorization: `Bearer ${token}` },
                });
            }
    ...
    const handleEliminar = async (id) => {
        if (confirm("¿Eliminar esta cancha?")) {
            try {
                await axios.delete(`https://golgana.com/api/canchas/${id}`, {
                    headers: { Authorization: `Bearer ${token}` },
                });
                obtenerCanchas();
            } catch (error) {
